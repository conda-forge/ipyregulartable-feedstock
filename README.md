...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyregulartable-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11261&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyregulartable-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyregulartable` can be installed with:

```
conda install ipyregulartable
```

It is possible to list all of the versions of `ipyregulartable` available on your platform with:
